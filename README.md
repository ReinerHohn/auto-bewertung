...
- **🕵️ Kauf-Check** – **Betrugs-Check** (automatische Warnung bei Preis weit unter fairem Marktwert + Liste typischer Maschen mit Erkennen/Schutz), km-Plausibilität (Rückdreh-Warnung), **HU/TÜV-Fälligkeit** (aus EZ berechnet), **Gewährleistung** (Privat vs. Händler), **Umweltzonen-/Diesel-Fahrverbots-Hinweis**, fällige/anstehende Teile, **Nähe-Warnung** („in ~X km Reparatur Y"), Rückrufe, Profi-Checkliste (Tacho, Unfall, Technik, **Recht & Papiere**), carVertical/AutoDNA-Links. **🤝 Verhandeln & Dossier:** Modell-Achtungsliste (Top-Schwachstellen zum gezielt Prüfen), **Verhandlungs-Munition** (alle fälligen Kosten/Rückrufe/Standzeit → Argumente + geschätzter Nachlass + Zielpreis) und ein **kopier-/druckbares Kauf-Dossier** für den Besichtigungstermin.
